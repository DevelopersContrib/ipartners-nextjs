...
/**
 * Cloudflare Email Worker → ipartners-nextjs support inbox.
 *
 * Email Routing for support@ipartners.com should send to this Worker.
 ...
 *   WEBHOOK_URL  — e.g. https://www.ipartners.com/api/webhooks/support-inbound
 */
