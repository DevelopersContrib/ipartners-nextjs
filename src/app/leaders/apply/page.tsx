...
export default async function LeadersApplyPage() {
  ...
  return (
    <div className="py-16 px-4 bg-[#0D1210] min-h-screen">
      <div className="max-w-2xl mx-auto">
        ...
        <div id="apply-form">
          <ApplicationForm partnershipType="leaders" domain={DOMAIN} initialEmail={partner?.email ?? ''} initialProfile={profile ?? undefined} />
        </div>
      </div>
    </div>
  );
