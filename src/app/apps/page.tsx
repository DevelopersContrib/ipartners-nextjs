    ...
    <>
      <section className="relative hero-gradient-green py-20 sm:py-28 lg:py-32 px-4 text-white overflow-hidden">
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="mt-10"><Link href="/apply?mode=app" className="inline-flex items-center justify-center bg-emerald-400 text-black px-8 py-4 rounded-xl text-lg font-bold hover:bg-emerald-300 transition-all shadow-lg">Apply Now <svg className="ml-2 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg></Link></div>
        </div>
      </section>
      <section className="py-20 sm:py-24 px-4 bg-[#0D1210]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-16 text-center"><Link href="/apply?mode=app" className="inline-flex items-center justify-center bg-emerald-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-emerald-500 transition-all shadow-lg shadow-emerald-600/20">Start Your App Partnership</Link></div>
        </div>
      </section>
    </>
  );
