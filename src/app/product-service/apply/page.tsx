...
export const metadata: Metadata = {
  ...
  description: 'Apply to become a product or service partner with iPartner.',
};
    ...
    <div className="py-16 px-4 bg-[#0D1210] min-h-screen">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-10">
          <h1 className="text-3xl sm:text-4xl font-bold text-white">Product & Service Partnership Application</h1>
          <p className="text-[#5A6E62] mt-3 max-w-lg mx-auto">
            Complete the form below to apply for a product or service partnership with iPartner.
          </p>
        ...
        <div id="apply-form">
          <ApplicationForm partnershipType="product-service" domain={DOMAIN} initialEmail={partner?.email ?? ''} initialProfile={profile ?? undefined} />
        </div>
      </div>
    </div>
  );
